        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    <a class="text-body mr-3" href="?c=">Acerca de nosotros</a>
                    <a class="text-body mr-3" href="?c=">Contactanos</a>
                    <a class="text-body mr-3" href="?c=">Ayuda</a>
                    <a class="text-body mr-3" href="?c=">Preguntar frecuentes</a>
                </div>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="?c=inicio" class="nav-item nav-link active">Inicio</a>
